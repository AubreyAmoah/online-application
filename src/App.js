...
const MainPage = () => {
  return (
    <div className="">
      ...
      <Link
        className="w-[60px] h-[60px] rounded-full bg-sky-900 text-white flex flex-col justify-center items-center absolute top-[20%] left-10"
        to="/"
      >
        ...
        <div className="bg-zinc-100 rounded-md p-6 w-[800px] ml-auto mr-auto mt-28">
          ...
          <div className="flex flex-col mt-6">
            ...
            <div className="flex mt-6 justify-between items-center">
              <button className="rounded-md p-4 text-white bg-gray-500 w-[100px]">
                back
              </button>
          ...
          <div className="flex">
            <div className="flex flex-col">
              ...
              <div className="flex text-l gap-8">
                <div className="flex gap-2">
                  <input type="checkbox" /> <span>Credit Card</span>{" "}
                </div>

                <div className="flex gap-2">
                  <input type="checkbox" /> <span>In-person</span>{" "}
                </div>
              </div>
            </div>
          </div>
